...
fit_PLCO_BMI_female <- function(plco_race_edu) {
## plco_file, impfile, nafile,
	...
	if(Gender=="F")  Head="17_0303_PLCO.fit.models_female"
	...
	##setwd(outdir)
	PROB.edu.race = read.csv(plco_race_edu) # paste(Head,".probs.race.edu.norm.csv",sep=""))
	...
	print("fit PCLO BMI female successful!")
